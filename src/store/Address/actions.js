...
export const addAddressRequest = (address,resetForm) => ({
  type: ADD_ADDRESS_REQUEST,
  payload: { address,resetForm },
});
...
export const updateAddressRequest = (id,address, resetForm) => ({
  type: UPDATE_ADDRESS_REQUEST,
  payload: { address, id, resetForm},
});
...
// Set address form errors
export const setAddressErrors = (errors) => ({
  type: SET_ADDRESS_ERRORS,
  payload: errors,
});
